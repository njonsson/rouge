...
Rouge has around 600 executable specifications authored using the "Screw.Unit":http://github.com/nathansobo/screw-unit framework. Run the specs by opening _src/spec/suite.html_. (Firefox works best for this.)
